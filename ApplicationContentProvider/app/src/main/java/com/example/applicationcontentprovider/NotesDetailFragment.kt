...
class NotesDetailFragment : DialogFragment(), DialogInterface.OnClickListener {
    ...
    override fun onClick(dialog: DialogInterface?, which: Int) {
        //Todos os dados que criamos e inputamos para o contentprovider, ele obrigatoriamente deve vir da classe ContentValues
        val values = ContentValues()
        values.put(TITLE_NOTES, noteEditTitle.text.toString()) //vai mostrar qual coluna dentro do banco de dados que queremos popular
